...
<body>
  ...
  <header class="header">
    <div class="container nav">
      <a href="<?php echo e(route('home')); ?>" aria-label="Maccento">
        <img loading="eager" fetchpriority="high" decoding="async" class="logo" src="<?php echo e(asset('assets/media/logo-footer.png')); ?>" alt="Maccento logo">
      </a>
      <nav class="nav-links">
        <a href="<?php echo e(route('about')); ?>">ABOUT US</a>
        <a href="<?php echo e(route('services')); ?>">OUR SERVICES</a>
        <a href="<?php echo e(route('portfolio')); ?>">PORTFOLIO</a>
        <a href="<?php echo e(route('plan')); ?>">OUR PLAN</a>
      </nav>
      <div class="nav-actions">
        <div class="nav-cta">
          <a class="btn header-login-btn" href="<?php echo e(route('login')); ?>">Client Login</a>
        </div>
    ...
    <nav id="mobile-menu" class="mobile-menu" aria-hidden="true">
      <div class="container mobile-menu-inner">
        <a class="mobile-menu-login" href="<?php echo e(route('login')); ?>">CLIENT LOGIN</a>
        <a class="mobile-menu-link" href="<?php echo e(route('about')); ?>">ABOUT US</a>
        <a class="mobile-menu-link" href="<?php echo e(route('services')); ?>">OUR SERVICES</a>
        <a class="mobile-menu-link" href="<?php echo e(route('portfolio')); ?>">PORTFOLIO</a>
        <a class="mobile-menu-link" href="<?php echo e(route('plan')); ?>">OUR PLAN</a>
  ...
  <main id="top">
    <?php if(!$isHome && $page !== 'services' && $page !== 'portfolio' && $page !== 'plan' && $page !== 'about'): ?>
    <section class="section page-intro">
      <div class="container">
        <h1 class="section-title page-intro-title">
          <?php if($page === 'services'): ?> Our Services <?php endif; ?>
          <?php if($page === 'portfolio'): ?> Portfolio <?php endif; ?>
          <?php if($page === 'plan'): ?> Our Plan <?php endif; ?>
        </h1>
      </div>
    </section>
    <?php endif; ?>
      ...
      <div class="container about-grid">
        <div class="about-copy">
          ...
          <div class="about-cta">
            ...
            <a class="btn about-ghost-btn" href="<?php echo e(route('plan')); ?>">See our plans</a>
          </div>
        </div>
        <div class="about-collage" aria-label="About Maccento gallery">
          <figure class="about-card card-a"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos1.webp')); ?>" alt="Team discussing listing assets"></figure>
          <figure class="about-card card-b"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos2.webp')); ?>" alt="Client strategy meeting"></figure>
          <figure class="about-card card-c"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos3.webp')); ?>" alt="Production workflow"></figure>
          <figure class="about-card card-d"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos4.webp')); ?>" alt="Creative team collaboration"></figure>
          <figure class="about-card card-e"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos5.webp')); ?>" alt="Planning session with brokers"></figure>
        </div>
      </div>
    </section>
        ...
        <div class="why-orbit">
          <div class="why-col">
            <article class="why-item">
              <div class="why-item-icon">
                <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/icon/Cinematic Property Films.webp')); ?>" alt="Tailored Creative Approach icon">
              </div>
            ...
            <article class="why-item">
              <div class="why-item-icon">
                <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/icon/Express Video Walkthroughs.webp')); ?>" alt="Fast, Reliable Turnaround icon">
              </div>
          ...
          <div class="why-center-media">
            <video class="lazy-video" autoplay muted loop playsinline preload="none">
              <source data-src="<?php echo e(asset('assets/media/webm/Videos3.webm')); ?>" type="video/webm">
            </video>
          </div>
          <div class="why-col">
            <article class="why-item">
              <div class="why-item-icon">
                <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/icon/Drone Photography & Video.webp')); ?>" alt="Certified and Fully Insured Drone Operations icon">
              </div>
            ...
            <article class="why-item">
              <div class="why-item-icon">
                <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/icon/Social Media Content for Brokers.webp')); ?>" alt="Flexible Scheduling icon">
              </div>
    ...
    <section class="hero">
      <video autoplay muted loop playsinline preload="auto">
        <source src="<?php echo e(asset('assets/media/webm/Videos4.webm')); ?>" type="video/webm">
      </video>
      <div class="container">
        ...
        <div class="cta-row">
          <a class="btn btn-primary" href="<?php echo e(route('login')); ?>">Book Now</a>
          <a class="btn btn-ghost" href="<?php echo e(route('plan')); ?>">View Packages</a>
        </div>
      </div>
    </section>
    <?php endif; ?>
    ...
    <section id="why" class="section offerings">
      <div class="container">
        ...
        <div class="offer-grid">
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/Professional Photography (HDR).webp')); ?>" alt="Professional Photography">
            <h4>Professional Photography (HDR)</h4>
            <p>High-end interior & exterior photography for residential and commercial listings.</p>
          </div>
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/Cinematic Property Films.webp')); ?>" alt="Cinematic Property Films">
            <h4>Cinematic Property Films</h4>
            <p>High-production videos with storytelling, music, gimbal movement, and drone integration.</p>
          </div>
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/Express Video Walkthroughs.webp')); ?>" alt="Express Video Walkthroughs">
            <h4>Express Video Walkthroughs</h4>
            <p>Clean, fast, MLS-friendly walkthroughs designed for speed, volume, and social use.</p>
          </div>
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/Drone Photography & Video.webp')); ?>" alt="Drone Photography">
            <h4>Drone Photography & Video</h4>
            <p>Aerial imagery and video to showcase location, scale, surroundings, and access points.</p>
          </div>
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/Virtual Staging.webp')); ?>" alt="Virtual Staging">
            <h4>Virtual Staging</h4>
            <p>Digitally staged interiors to help buyers visualize scale, layout, and lifestyle.</p>
          </div>
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/Day-to-Dusk.webp')); ?>" alt="Day-to-Dusk">
            <h4>Day-to-Dusk</h4>
            <p>Twilight-style exterior imagery to enhance curb appeal and listing presence.</p>
          </div>
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/3D Tours.webp')); ?>" alt="3D Tours">
            <h4>3D Tours (Matterport) - coming soon</h4>
            <p>Immersive virtual tours allowing buyers and tenants to explore spaces remotely.</p>
          </div>
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/Floor Plans.webp')); ?>" alt="Floor Plans">
            <h4>Floor Plans (coming soon)</h4>
            <p>Accurate 2D & 3D floor plans for listings, marketing materials, and commercial use.</p>
          </div>
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/Social Media Content for Brokers.webp')); ?>" alt="Social Media Content">
            <h4>Social Media Content for Brokers</h4>
            <p>Short-form videos, reels, and visuals designed for Instagram, TikTok, and LinkedIn.</p>
          </div>
          <div class="offer">
            <img loading="lazy" decoding="async" class="offer-icon" src="<?php echo e(asset('assets/media/icon/Photo Retouching & Media Enhancement.webp')); ?>" alt="Photo Retouching">
        ...
        <div class="examples-grid">
          <article class="example-card">
            <div class="example-media video-card">
              ...
              <video class="lazy-video" autoplay muted loop playsinline preload="none">
                <source data-src="<?php echo e(asset('assets/media/webm/Videos2.webm')); ?>" type="video/webm">
              </video>
            </div>
          ...
          <article class="example-card">
            <div class="example-media compare-media" data-compare>
              <img class="compare-before" loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/Service Examples/Virtual staging before.webp')); ?>" alt="Virtual staging before example">
              <div class="compare-after-wrap">
                <img class="compare-after" loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/Service Examples/Virtual staging after.webp')); ?>" alt="Virtual staging after example">
              </div>
          ...
          <article class="example-card">
            <div class="example-media compare-media" data-compare>
              <img class="compare-before" loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/Service Examples/Day-to-dusk edits before.webp')); ?>" alt="Day to dusk before example">
              <div class="compare-after-wrap">
                <img class="compare-after" loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/Service Examples/Day-to-dusk edits after.webp')); ?>" alt="Day to dusk after example">
              </div>
              <span class="split-tag compare-tag before">Before</span>
              <span class="split-tag compare-tag after">After</span>
              <button class="compare-handle" type="button" aria-label="Drag to compare before and after" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50">
          ...
          <article class="example-card">
            <div class="example-media compare-media" data-compare>
              <img class="compare-before" loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/Service Examples/Image editing_object removal before.webp')); ?>" alt="Image editing before example">
              <div class="compare-after-wrap">
                <img class="compare-after" loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/Service Examples/Image editing_object removal after.webp')); ?>" alt="Image editing after example">
              </div>
              <span class="split-tag compare-tag before">Before</span>
              <span class="split-tag compare-tag after">After</span>
              <button class="compare-handle" type="button" aria-label="Drag to compare before and after" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50">
        ...
        <div class="services-grid">
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos1.webp')); ?>" alt="Professional Photography (HDR)">
            </figure>
          ...
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos2.webp')); ?>" alt="Cinematic Property Films">
            </figure>
            <div class="service-content">
              <div class="service-head">
          ...
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos3.webp')); ?>" alt="Express Video Walkthroughs">
            </figure>
            <div class="service-content">
              <div class="service-head">
          ...
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/drone/drone1.webp')); ?>" alt="Drone Photography & Video">
            </figure>
            <div class="service-content">
              <div class="service-head">
          ...
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos4.webp')); ?>" alt="Virtual Staging">
            </figure>
            <div class="service-content">
              <div class="service-head">
                <h3>Virtual Staging</h3>
          ...
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos5.webp')); ?>" alt="Day-to-Dusk">
            </figure>
            <div class="service-content">
              <div class="service-head">
                <h3>Day-to-Dusk</h3>
          ...
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos6.webp')); ?>" alt="3D Tours (Matterport) - coming soon">
            </figure>
            <div class="service-content">
              <div class="service-head">
          ...
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/drone/drone2.webp')); ?>" alt="Floor Plans (coming soon)">
            </figure>
            <div class="service-content">
              <div class="service-head">
          ...
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/drone/drone3.webp')); ?>" alt="Social Media Content for Brokers">
            </figure>
            <div class="service-content">
              <div class="service-head">
          ...
          <article class="service-card reveal-on-scroll">
            <figure class="service-media">
              <img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/drone/drone4.webp')); ?>" alt="Photo Retouching & Media Enhancement">
            </figure>
            <div class="service-content">
              <div class="service-head">
    ...
    <section id="portfolio" class="section <?php echo e($isHome ? 'portfolio-home' : ''); ?>">
      <div class="container">
        ...
        <div class="portfolio-grid" data-portfolio-grid>
          <article class="portfolio-item" data-category="residential" data-media="photo">
            <figure class="portfolio-media"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos1.webp')); ?>" alt="Residential photo 1"></figure>
          ...
          <article class="portfolio-item" data-category="residential" data-media="video">
            <figure class="portfolio-media"><video class="lazy-video" autoplay muted loop playsinline preload="none"><source data-src="<?php echo e(asset('assets/media/webm/Videos1.webm')); ?>" type="video/webm"></video></figure>
          ...
          <article class="portfolio-item" data-category="residential" data-media="drone">
            <figure class="portfolio-media"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/drone/drone1.webp')); ?>" alt="Residential drone 1"></figure>
            <p class="portfolio-caption">Residential Drone View</p>
          </article>
          <article class="portfolio-item" data-category="residential" data-media="photo">
            <figure class="portfolio-media"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos2.webp')); ?>" alt="Residential photo 2"></figure>
            <p class="portfolio-caption">Residential Interior Photo</p>
          </article>
          <article class="portfolio-item" data-category="residential" data-media="video">
            <figure class="portfolio-media"><video class="lazy-video" autoplay muted loop playsinline preload="none"><source data-src="<?php echo e(asset('assets/media/webm/Videos2.webm')); ?>" type="video/webm"></video></figure>
            <p class="portfolio-caption">Residential Reel Clip</p>
          </article>
          <article class="portfolio-item" data-category="residential" data-media="drone">
            <figure class="portfolio-media"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/drone/drone2.webp')); ?>" alt="Residential drone 2"></figure>
          ...
          <article class="portfolio-item hidden" data-category="commercial" data-media="photo">
            <figure class="portfolio-media"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos5.webp')); ?>" alt="Commercial photo 1"></figure>
          ...
          <article class="portfolio-item hidden" data-category="commercial" data-media="video">
            <figure class="portfolio-media"><video class="lazy-video" autoplay muted loop playsinline preload="none"><source data-src="<?php echo e(asset('assets/media/webm/Videos3.webm')); ?>" type="video/webm"></video></figure>
          ...
          <article class="portfolio-item hidden" data-category="commercial" data-media="drone">
            <figure class="portfolio-media"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/drone/drone3.webp')); ?>" alt="Commercial drone 1"></figure>
            <p class="portfolio-caption">Commercial Drone View</p>
          </article>
          <article class="portfolio-item hidden" data-category="commercial" data-media="photo">
            <figure class="portfolio-media"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/photos/photos6.webp')); ?>" alt="Commercial photo 2"></figure>
            <p class="portfolio-caption">Commercial Interior Photo</p>
          </article>
          <article class="portfolio-item hidden" data-category="commercial" data-media="video">
            <figure class="portfolio-media"><video class="lazy-video" autoplay muted loop playsinline preload="none"><source data-src="<?php echo e(asset('assets/media/webm/Videos4.webm')); ?>" type="video/webm"></video></figure>
            <p class="portfolio-caption">Commercial Promo Video</p>
          </article>
          <article class="portfolio-item hidden" data-category="commercial" data-media="drone">
            <figure class="portfolio-media"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/portfolio/drone/drone4.webp')); ?>" alt="Commercial drone 2"></figure>
    ...
    <section id="video" class="section cinematic">
      <div class="container video-split">
        <div class="video-copy">
          ...
          <div class="video-cta">
            <a class="btn btn-primary" href="<?php echo e(route('login')); ?>">Get started</a>
            <a class="btn btn-ghost" href="<?php echo e(route('plan')); ?>">View packages</a>
          </div>
        </div>
        <div class="video-media">
          <video class="lazy-video broker-video" autoplay muted loop playsinline preload="none" poster="<?php echo e(asset('assets/media/hero.webp')); ?>">
            <source data-src="<?php echo e(asset('assets/media/webm/Videos3.webm')); ?>" type="video/webm">
          </video>
        </div>
      </div>
        ...
        <div class="creative-layout">
          ...
          <div class="creative-side-video" aria-hidden="true">
            <div class="phone-shell">
              ...
              <video class="lazy-video" autoplay muted loop playsinline preload="none">
                <source data-src="<?php echo e(asset('assets/media/webm/Videos1.webm')); ?>" type="video/webm">
              </video>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="brand-marquee" aria-label="Partner logos">
          <div class="brand-track">
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (1).webp')); ?>" alt="Partner logo 1"></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (2).webp')); ?>" alt="Partner logo 2"></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (3).webp')); ?>" alt="Partner logo 3"></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (4).webp')); ?>" alt="Partner logo 4"></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (5).webp')); ?>" alt="Partner logo 5"></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (6).webp')); ?>" alt="Partner logo 6"></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (7).webp')); ?>" alt="Partner logo 7"></div>
          </div>
          <div class="brand-track" aria-hidden="true">
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (1).webp')); ?>" alt=""></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (2).webp')); ?>" alt=""></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (3).webp')); ?>" alt=""></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (4).webp')); ?>" alt=""></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (5).webp')); ?>" alt=""></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (6).webp')); ?>" alt=""></div>
            <div class="brand-logo"><img loading="lazy" decoding="async" src="<?php echo e(asset('assets/media/company_logo/company_logo (7).webp')); ?>" alt=""></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section final-cta" aria-labelledby="final-cta-title">
      <div class="container">
        <div class="final-cta-card">
          ...
          <a class="btn btn-primary final-cta-btn" href="<?php echo e(route('login')); ?>">Book Now</a>
        </div>
      </div>
    </section>
    <?php endif; ?>
  ...
  <footer class="footer">
    <div class="container footer-inner">
      <img loading="lazy" decoding="async" class="footer-logo" src="<?php echo e(asset('assets/media/logo-footer.png')); ?>" alt="Maccento logo">
      ...
      <div class="footer-contact-line">
        <a class="footer-contact-item" href="mailto:<?php echo e($companyEmail); ?>">
          ...
          <span class="contact-text"><?php echo e($companyEmail); ?></span>
        </a>
        <span class="footer-contact-dot" aria-hidden="true">&bull;</span>
        <a class="footer-contact-item" href="tel:<?php echo e($companyPhoneHref); ?>">
          <span class="contact-icon">
            <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <span class="contact-text"><?php echo e($companyPhone); ?></span>
        </a>
      </div>
  ...
  <section class="site-chat" aria-label="AI chat assistant">
    <button class="site-chat-toggle" type="button" data-chat-toggle aria-expanded="false" aria-controls="site-chat-panel" aria-label="Open AI chat assistant">
      <img class="site-chat-toggle-icon" src="<?php echo e(asset('assets/media/icon/ai_icon.png')); ?>" alt="" aria-hidden="true" onerror="this.style.display='none';this.parentElement.classList.add('no-icon');">
...
<?php /**PATH /home/asifk/projects/maccento/resources/views/welcome.blade.php ENDPATH**/ ?>