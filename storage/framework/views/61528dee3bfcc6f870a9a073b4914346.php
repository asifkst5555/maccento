  ...
  <section class="panel-stack">
    <article class="panel-card panel-stack crm-mailbox-main-card">
      <div class="panel-form-row crm-mailbox-main-head" style="align-items:center;">
        <h2 class="panel-section-title" style="margin:0; text-transform:capitalize;"><?php echo e($activeFolder); ?></h2>
      </div>

      <nav class="crm-mail-tabs" aria-label="Mailbox folders">
        <a class="crm-mail-tab <?php if($activeFolder === 'inbox'): ?> is-active <?php endif; ?>" href="<?php echo e(route('admin.emails.inbox')); ?>">Inbox <span><?php echo e(number_format($inboxCount)); ?></span></a>
        <a class="crm-mail-tab <?php if($activeFolder === 'sent'): ?> is-active <?php endif; ?>" href="<?php echo e(route('admin.emails.sent')); ?>">Sent <span><?php echo e(number_format($sentCount)); ?></span></a>
        <a class="crm-mail-tab <?php if($activeFolder === 'drafts'): ?> is-active <?php endif; ?>" href="<?php echo e(route('admin.emails.drafts')); ?>">Drafts <span><?php echo e(number_format($draftCount)); ?></span></a>
      </nav>
        ...
        <section class="crm-mailbox-list-col">
          <div class="panel-table-wrap">
            ...
            <table class="panel-table crm-mailbox-table">
              <?php if($activeFolder === 'inbox'): ?>
              <thead><tr><th>From</th><th>Subject</th><th>Linked CRM</th><th>Received</th><th>Actions</th></tr></thead>
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $mailboxItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="crm-mail-row <?php if((int) $openMessageId === (int) $item->id): ?> is-active <?php endif; ?>" data-open-href="<?php echo e(route('admin.emails.inbox', array_merge($baseQuery, ['open_id' => $item->id]))); ?>">
                  <td class="crm-cell-truncate"><?php echo e($item->from_name ?: $item->from_email); ?></td>
                  <td class="crm-cell-truncate"><?php echo e($item->subject ?: '(No subject)'); ?></td>
                  <td class="crm-cell-truncate">
                    <?php if($item->client): ?>
                    <?php echo e($item->client->name); ?> <?php if($item->project?->title): ?> - <?php echo e($item->project->title); ?> <?php endif; ?>
                    <?php else: ?>
                    Unmatched
                    <?php endif; ?>
                  </td>
                  <td><?php echo e($item->received_at?->format('Y-m-d H:i') ?: ($item->created_at?->format('Y-m-d H:i') ?: '-')); ?></td>
                  <td class="crm-mail-actions">
                    <a class="panel-btn crm-btn-icon" href="<?php echo e(route('admin.emails.inbox', array_merge($baseQuery, ['open_id' => $item->id]))); ?>" title="View email" aria-label="View email"><span class="crm-ui-icon"><svg viewBox="0 0 20 20" aria-hidden="true"><path d="M2.5 10s2.8-4.5 7.5-4.5 7.5 4.5 7.5 4.5-2.8 4.5-7.5 4.5S2.5 10 2.5 10zm7.5 2.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z" fill="none" stroke="currentColor" stroke-width="1.5"/></svg></span></a>
                    <form method="post" action="<?php echo e(route('admin.emails.inbox.delete', $item)); ?>" data-app-confirm="1" data-confirm-message="Delete this inbox email?">
                      <?php echo csrf_field(); ?>
                      <button class="panel-btn panel-btn-danger crm-btn-icon" type="submit" title="Delete email" aria-label="Delete email"><span class="crm-ui-icon"><?php if (isset($component)) { $__componentOriginal669c17867d57615948fae15a035429b3 = $component; } ?>
...
<?php endif; ?></span></button>
              ...
              <?php elseif($activeFolder === 'drafts'): ?>
              <thead><tr><th>Recipient</th><th>Subject</th><th>Updated</th><th>Actions</th></tr></thead>
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $mailboxItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="crm-mail-row <?php if((int) $openMessageId === (int) $item->id): ?> is-active <?php endif; ?>" data-open-href="<?php echo e(route('admin.emails.drafts', array_merge($baseQuery, ['open_id' => $item->id, 'draft' => $item->id]))); ?>">
                  <td><?php echo e($item->recipient_email ?: '-'); ?></td>
                  <td><?php echo e($item->subject ?: '(No subject)'); ?></td>
                  <td><?php echo e($item->updated_at?->format('Y-m-d H:i') ?: '-'); ?></td>
                  <td class="crm-mail-actions crm-mail-actions--draft">
                    <a class="panel-btn crm-btn-icon" href="<?php echo e(route('admin.emails.drafts', ['open_id' => $item->id, 'draft' => $item->id])); ?>" title="View draft" aria-label="View draft"><span class="crm-ui-icon"><svg viewBox="0 0 20 20" aria-hidden="true"><path d="M2.5 10s2.8-4.5 7.5-4.5 7.5 4.5 7.5 4.5-2.8 4.5-7.5 4.5S2.5 10 2.5 10zm7.5 2.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z" fill="none" stroke="currentColor" stroke-width="1.5"/></svg></span></a>
                    <a class="panel-link crm-btn-icon" href="<?php echo e(route('admin.emails.drafts', ['draft' => $item->id])); ?>" title="Edit draft" aria-label="Edit draft"><span class="crm-ui-icon"><svg viewBox="0 0 20 20" aria-hidden="true"><path d="M4 14.8h2.4L14 7.2 11.8 5 4.2 12.6V15zM10.9 6l2.2 2.2" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span></a>
                    <form method="post" action="<?php echo e(route('admin.emails.drafts.send', $item)); ?>">
                      <?php echo csrf_field(); ?>
                    ...
                    <form method="post" action="<?php echo e(route('admin.emails.drafts.delete', $item)); ?>" data-app-confirm="1" data-confirm-message="Delete this draft?">
                      <?php echo csrf_field(); ?>
                      <button class="panel-btn panel-btn-danger crm-btn-icon" type="submit" title="Delete draft" aria-label="Delete draft"><span class="crm-ui-icon"><?php if (isset($component)) { $__componentOriginal669c17867d57615948fae15a035429b3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal669c17867d57615948fae15a035429b3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel-icon','data' => ['name' => 'trash']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('panel-icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></span></button>
              ...
              <tbody>
                ...
                ?>
                <tr class="crm-mail-row <?php if((int) $openMessageId === (int) $item->id): ?> is-active <?php endif; ?>" data-open-href="<?php echo e(route('admin.emails.sent', array_merge($baseQuery, ['open_id' => $item->id]))); ?>">
                  <td class="crm-cell-truncate"><?php echo e($item->recipient_email); ?></td>
                  <td class="crm-cell-truncate"><?php echo e($item->subject); ?></td>
                  <td><span class="panel-badge <?php if($item->status === 'failed'): ?> panel-badge-danger <?php endif; ?>"><?php echo e(strtoupper($item->status)); ?></span></td>
                  <td><?php echo e($item->sent_at?->format('Y-m-d H:i') ?: '-'); ?></td>
                  <td>
                    ...
                    <div class="crm-timeline-mini">
                      ...
                      <div><strong><?php echo e(strtoupper((string) $event->event_type)); ?></strong> <span><?php echo e($event->occurred_at?->format('m-d H:i') ?: ''); ?></span></div>
                  ...
                  <td class="crm-mail-actions">
                    <a class="panel-btn crm-btn-icon" href="<?php echo e(route('admin.emails.sent', array_merge($baseQuery, ['open_id' => $item->id]))); ?>" title="View sent email" aria-label="View sent email"><span class="crm-ui-icon"><svg viewBox="0 0 20 20" aria-hidden="true"><path d="M2.5 10s2.8-4.5 7.5-4.5 7.5 4.5 7.5 4.5-2.8 4.5-7.5 4.5S2.5 10 2.5 10zm7.5 2.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z" fill="none" stroke="currentColor" stroke-width="1.5"/></svg></span></a>
                    <form method="post" action="<?php echo e(route('admin.emails.sent.delete', $item)); ?>" data-app-confirm="1" data-confirm-message="Delete this sent email record?">
                      <?php echo csrf_field(); ?>
                      <button class="panel-btn panel-btn-danger crm-btn-icon" type="submit" title="Delete sent email" aria-label="Delete sent email"><span class="crm-ui-icon"><?php if (isset($component)) { $__componentOriginal669c17867d57615948fae15a035429b3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal669c17867d57615948fae15a035429b3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel-icon','data' => ['name' => 'trash']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('panel-icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel-pagination','data' => ['paginator' => $mailboxItems]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mailboxItems)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div id="detailModal" class="crm-detail-modal <?php if($detailShouldOpen): ?> is-open <?php endif; ?>" role="dialog" aria-modal="true" aria-labelledby="detailModalTitle" aria-hidden="<?php if($detailShouldOpen): ?>false <?php else: ?> true <?php endif; ?>">
      ...
      <article class="crm-detail-modal__card panel-card panel-stack">
        <section class="crm-thread-pane">
          <div class="crm-thread-pane__header">
            <h3 id="detailModalTitle"><?php echo e(data_get($threadMessages->first(), 'subject', 'Message detail')); ?></h3>
            <div class="panel-form-row" style="gap:8px; align-items:center;">
              ...
              ?>
              <?php if($selectedMessage && $replyToEmail !== ''): ?>
              <button class="panel-btn panel-btn-primary crm-btn-icon" type="button" id="detailReplyBtn" data-reply-to="<?php echo e($replyToEmail); ?>" data-reply-subject="<?php echo e($replySubject); ?>" data-reply-project-id="<?php echo e($replyProjectId); ?>"><span class="crm-ui-icon"><svg viewBox="0 0 20 20" aria-hidden="true"><path d="M8 6L3 10l5 4M4 10h9a4 4 0 0 1 4 4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Reply</button>
              <?php endif; ?>
          ...
          <?php if($selectedMessage): ?>
            ...
            <div class="panel-form-row" style="gap:8px; align-items:center; flex-wrap:wrap;">
              ...
              <?php if($selectedMessage->client): ?>
              <span class="panel-badge">Client: <?php echo e($selectedMessage->client->name); ?></span>
              <?php endif; ?>
              <?php if($selectedMessage->project): ?>
              <span class="panel-badge">Project: <?php echo e($selectedMessage->project->title); ?></span>
              <?php endif; ?>
            </div>
            <?php elseif($activeFolder === 'sent'): ?>
            <div class="panel-form-row" style="gap:8px; align-items:center; flex-wrap:wrap;">
              <span class="panel-badge">Sent</span>
              <span class="panel-badge">Status: <?php echo e(strtoupper((string) ($selectedMessage->status ?? 'sent'))); ?></span>
              <span class="panel-badge">To: <?php echo e($selectedMessage->recipient_email); ?></span>
            </div>
            <?php if(($selectedEmailEventTimeline ?? collect())->count() > 0): ?>
            <div class="crm-thread-events">
              <?php $__currentLoopData = ($selectedEmailEventTimeline ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div><strong><?php echo e(strtoupper((string) $event->event_type)); ?></strong> <span><?php echo e($event->occurred_at?->format('Y-m-d H:i') ?: '-'); ?></span></div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php endif; ?>
            <?php else: ?>
            ...
            <div class="crm-thread-list">
              <?php $__currentLoopData = $threadMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thread): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <article class="crm-thread-message <?php if((bool) ($thread['is_selected'] ?? false)): ?> is-selected <?php endif; ?>">
                <div class="crm-thread-message__meta">
                  <strong><?php echo e(strtoupper((string) ($thread['direction'] ?? 'message'))); ?></strong>
                  <span><?php echo e((string) ($thread['display_at'] ?? '-')); ?></span>
                </div>
                <p class="crm-thread-message__from">
                  From: <?php echo e((string) ($thread['from_label'] ?? '-')); ?>

                  <?php if(!blank($thread['from_email'] ?? null)): ?>
                  <span class="panel-muted">(<?php echo e((string) $thread['from_email']); ?>)</span>
                  <?php endif; ?>
                </p>
                <p class="crm-thread-message__to">To: <?php echo e((string) ($thread['to_email'] ?? '-')); ?></p>
                <h4><?php echo e((string) ($thread['subject'] ?? '(No subject)')); ?></h4>
                <pre><?php echo e((string) (($thread['body'] ?? '') !== '' ? $thread['body'] : '(No message body stored)')); ?></pre>
              </article>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          <?php else: ?>
    ...
    <div id="composeModal" class="crm-compose-modal <?php if($composeShouldOpen): ?> is-open <?php endif; ?>" role="dialog" aria-modal="true" aria-labelledby="composeModalTitle" aria-hidden="<?php if($composeShouldOpen): ?>false <?php else: ?> true <?php endif; ?>">
    ...
    <article id="composeCard" class="panel-card panel-stack crm-compose-card crm-compose-modal__card">
      ...
      <section class="crm-compose-ai-panel panel-stack" aria-label="AI assistant tools">
        ...
        <label>
          ...
          <select id="aiTemplate" class="panel-select" aria-label="AI template">
            <option value="custom" <?php if((string) ($compose['ai_template'] ?? 'custom') === 'custom'): echo 'selected'; endif; ?>>Custom</option>
            <option value="cold_followup" <?php if((string) ($compose['ai_template'] ?? 'custom') === 'cold_followup'): echo 'selected'; endif; ?>>Cold Follow-up</option>
            <option value="quote_reminder" <?php if((string) ($compose['ai_template'] ?? 'custom') === 'quote_reminder'): echo 'selected'; endif; ?>>Quote Reminder</option>
            <option value="no_response_nudge" <?php if((string) ($compose['ai_template'] ?? 'custom') === 'no_response_nudge'): echo 'selected'; endif; ?>>No-response Nudge</option>
          </select>
        </label>
        <label style="flex:2;">
          <span>AI Goal / Instruction</span>
          <input id="aiGoal" class="panel-input" type="text" value="<?php echo e((string) ($compose['ai_goal'] ?? '')); ?>" placeholder="Example: Follow up warmly and propose two meeting time slots this week">
        </label>
        <label>
          <span>Tone</span>
      ...
      <form id="composeForm" method="post" action="<?php echo e(route('admin.emails.send')); ?>" enctype="multipart/form-data" class="panel-stack crm-compose-form">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="mode" value="custom">
        <input id="composeDraftId" type="hidden" name="draft_id" value="<?php echo e($compose['draft_id']); ?>">
        ...
        <div class="crm-compose-grid-2">
          <label>
            ...
            <input id="composeTo" class="panel-input" type="email" name="recipient_email" value="<?php echo e($compose['recipient_email']); ?>" placeholder="lead@example.com" required>
          </label>
          <label>
            <span>Reply-to Address</span>
            <input class="panel-input" type="email" name="reply_to" value="<?php echo e($compose['reply_to']); ?>" placeholder="crm@reply.maccento.ca" readonly>
          ...
          <label>
            ...
            <input class="panel-input" type="text" name="cc" value="<?php echo e($compose['cc']); ?>" placeholder="team@maccento.ca">
          </label>
          <label>
            <span>BCC <small class="panel-muted">(optional)</small></span>
            <input class="panel-input" type="text" name="bcc" value="<?php echo e($compose['bcc']); ?>" placeholder="archive@maccento.ca">
          </label>
        </div>
        ...
        <div class="crm-compose-grid-2">
          <label>
            ...
            <select id="composeProject" class="panel-select" name="client_project_id">
              ...
              <option value="<?php echo e($projectOption['id']); ?>" <?php if((string) $compose['client_project_id'] === (string) $projectOption['id']): echo 'selected'; endif; ?>><?php echo e($projectOption['label']); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          ...
          <label>
            <span>Subject</span>
            <input id="composeSubject" class="panel-input" type="text" name="subject" value="<?php echo e($compose['subject']); ?>" maxlength="180" placeholder="Example: Next Steps for Your Project" required>
        ...
        <label>
          ...
          <textarea id="composeMessage" class="panel-textarea" name="message" rows="10" required><?php echo e($compose['message']); ?></textarea>
        </label>
        ...
        <div class="panel-form-row" style="justify-content:space-between; align-items:center;">
          <div class="crm-compose-actions">
            <button id="manualSaveDraftBtn" class="panel-btn crm-btn-icon" formaction="<?php echo e(route('admin.emails.drafts.save')); ?>" formmethod="post" type="submit"><span class="crm-ui-icon"><svg viewBox="0 0 20 20" aria-hidden="true"><path d="M4 4h10l2 2v10H4V4zm2 0v4h8V5.2L12.8 4H6zm1 9h6" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/></svg></span>Save Draft</button>
            ...
            <?php if((int) ($compose['draft_id'] ?? 0) > 0): ?>
            <button class="panel-btn panel-btn-danger panel-btn-icon crm-btn-icon" type="submit" form="draftDeleteForm" title="Delete draft" aria-label="Delete draft"><span class="crm-ui-icon"><?php if (isset($component)) { $__componentOriginal669c17867d57615948fae15a035429b3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal669c17867d57615948fae15a035429b3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel-icon','data' => ['name' => 'trash']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('panel-icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></span></button>
          ...
          <span id="autosaveStatus" class="panel-muted">Lead ID: <?php echo e($compose['lead_id'] !== '' ? $compose['lead_id'] : 'n/a'); ?></span>
        </div>
      </form>
      <?php if((int) ($compose['draft_id'] ?? 0) > 0): ?>
      <form id="draftDeleteForm" method="post" action="<?php echo e(route('admin.emails.drafts.delete', ['draft' => (int) $compose['draft_id']])); ?>" data-app-confirm="1" data-confirm-message="Delete this draft?">
        <?php echo csrf_field(); ?>
      </form>
      <?php endif; ?>
    </article>
  ...
  <div id="appConfirmModal" class="crm-confirm-modal" role="dialog" aria-modal="true" aria-labelledby="appConfirmTitle" aria-hidden="true">
    ...
    <article class="crm-confirm-modal__card panel-card panel-stack">
      ...
      <div class="panel-form-row" style="justify-content:flex-end; gap:8px; margin-top:8px;">
        ...
        <button id="appConfirmOk" class="panel-btn panel-btn-danger panel-btn-icon" type="button" title="Confirm delete" aria-label="Confirm delete"><span class="panel-icon-trash" aria-hidden="true"><?php if (isset($component)) { $__componentOriginal669c17867d57615948fae15a035429b3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal669c17867d57615948fae15a035429b3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel-icon','data' => ['name' => 'trash']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('panel-icon'); ?>
<?php if ($component->shouldRender()): ?>
...
(function () {
  ...
  const autosaveDraft = async () => {
    ...
    try {
      ...
      payload.delete('attachments[]');
      const response = await fetch('<?php echo e(route('admin.emails.drafts.save')); ?>', {
        method: 'POST',
        headers: {
  ...
  aiWriteBtn?.addEventListener('click', async () => {
    ...
    try {
      const response = await fetch('<?php echo e(route('admin.emails.ai-write')); ?>', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          recipient_name: '<?php echo e(addslashes((string) $compose['recipient_name'])); ?>',
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/asifk/projects/maccento/resources/views/admin/emails-mailbox.blade.php ENDPATH**/ ?>