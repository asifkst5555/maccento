        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px; background:#ffffff; border-radius:14px; overflow:hidden; border:1px solid #d8e1f2;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" style="vertical-align:middle;">
                    <img src="<?php echo e($brandLogoUrl); ?>" alt="<?php echo e($brandName); ?>" style="height:25px; width:auto; display:block;" />
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:24px;">
              <h1 style="margin:0 0 10px; font-size:24px; line-height:1.25; color:#173a67;"><?php echo e($heading); ?></h1>

              <?php if(!empty($intro)): ?>
              <p style="margin:0 0 16px; font-size:14px; line-height:1.65; color:#334e73;"><?php echo e($intro); ?></p>
              <?php endif; ?>
              ...
              <p style="margin:0 0 12px; font-size:14px; line-height:1.65; color:#203753;"><?php echo e($line); ?></p>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" style="margin: 20px 0 6px;">
                <tr>
                  <td style="border-radius:8px; background:#0f2f57;">
                    <a href="<?php echo e($ctaUrl); ?>" style="display:inline-block; padding:12px 18px; color:#ffffff; text-decoration:none; font-size:14px; font-weight:700;"><?php echo e($ctaLabel); ?></a>
                  </td>
                </tr>
              </table>
              <?php endif; ?>
          ...
          <tr>
            <td style="padding:16px 24px 22px; background:#f8fbff; border-top:1px solid #e0e9f6;">
              <p style="margin:0; font-size:12px; line-height:1.5; color:#56708f;">
                <?php echo nl2br(e($footerNote ?: "Best regards,\nAlessio Battista\nMaccento Real Estate Media")); ?>
...
<?php /**PATH /home/asifk/projects/maccento/resources/views/emails/branded-notification.blade.php ENDPATH**/ ?>