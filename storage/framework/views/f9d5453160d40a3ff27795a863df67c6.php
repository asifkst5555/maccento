...
<section class="panel-card">
  <div class="panel-sticky-filters">
    <form method="get" class="panel-form-row">
      <input class="panel-input" type="text" name="lead_search" placeholder="Search package lead" value="<?php echo e($filters['lead_search']); ?>">
      ...
      <a class="panel-link" href="<?php echo e(route('admin.leads.packages.index')); ?>">Clear</a>
    </form>
    ...
    <table class="panel-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span class="panel-badge"><?php echo e($lead->conversation?->channel ?: 'package_builder'); ?></span></td>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/asifk/projects/maccento/resources/views/admin/package-leads-index.blade.php ENDPATH**/ ?>