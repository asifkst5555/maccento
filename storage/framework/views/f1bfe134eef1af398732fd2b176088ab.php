...
<svg viewBox="0 0 20 20" aria-hidden="true" <?php echo $attributes->merge(['class' => trim((string) $class)])->toHtml(); ?>>
    <?php echo $path; ?>

</svg>


<?php /**PATH /home/asifk/projects/maccento/resources/views/components/panel-icon.blade.php ENDPATH**/ ?>