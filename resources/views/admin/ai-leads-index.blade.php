...
<section class="panel-card">
  <div class="panel-sticky-filters">
    <form method="get" class="panel-form-row">
      <input class="panel-input" type="text" name="lead_search" placeholder="Search AI lead" value="{{ $filters['lead_search'] }}">
      ...
      <a class="panel-link" href="{{ route('admin.leads.ai.index') }}">Clear</a>
    </form>
    ...
    <table class="panel-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $lead->score }}</td>
          <td><span class="panel-badge">{{ $lead->conversation?->channel ?: 'website_widget' }}</span></td>
