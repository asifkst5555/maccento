...
return [
    ...
    'admin_assistant' => [
        ...
        'Messages' => 'Client message center for inbound email threads and internal replies.',
        'AI Leads' => 'Leads captured from the AI assistant experience.',
        'Package Leads' => 'Leads captured from the package builder workflow.',
        'Form Submissions' => 'Inbound website contact form submissions.',
        ...
        'System Health' => 'Queue, email failure, and backup health monitoring.',
        'Backup & Restore' => 'Create, upload, and restore database backups.',
        'Reports' => 'Operational reports and exports.',
        'Exports (CSV)' => 'Export leads and quotes for offline review.',
        'Follow-Ups' => 'Track pending follow-up reminders and workflows.',
        'Service Requests' => 'Client service requests with status tracking and updates.',
        'Booking Requests' => 'Inbound booking requests from the website.',
        'Request Edit Logs' => 'Audit trail for client-request edits.',
        'Settings' => 'API integrations, currency settings, invoice settings, and automation controls.',
        ],
        'role_rules' => [
