    ...
    'package_presets' => [
        'essential' => [
            ...
            'line_items' => [
                ...
                ['label' => 'Up to 20 Photos', 'amount' => 0],
                ['label' => 'Basic Retouching', 'amount' => 0],
                ['label' => '24 Hour Delivery', 'amount' => 0],
        ...
        'signature' => [
            ...
            'line_items' => [
                ...
                ['label' => 'Up to 30 Photos', 'amount' => 0],
                ['label' => 'Up to 7 Drone Photos', 'amount' => 0],
                ['label' => 'Exterior Photos', 'amount' => 0],
                ['label' => '24 Hour Delivery', 'amount' => 0],
            ],
            'notes' => [
                'Preset package price is fixed.',
        ...
        'prestige' => [
            ...
            'line_items' => [
                ...
                ['label' => 'Up to 40 Photos', 'amount' => 0],
                ['label' => 'Up to 10 Drone Photos', 'amount' => 0],
                ['label' => 'Interior & Exterior Images', 'amount' => 0],
                ['label' => 'Twilight Images', 'amount' => 0],
            ],
            'notes' => [
                'Preset package price is fixed.',
                'No extra options are added for this package.',
